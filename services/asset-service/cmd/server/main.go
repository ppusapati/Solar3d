...
import (
	...
	"p9e.in/samavaya/solar3d/asset-service/internal/config"
	"p9e.in/samavaya/solar3d/asset-service/internal/db"
...
func main() {
	...
	logger.Info().Str("port", cfg.Port).Msg("starting asset-service")
