...
import (
	...
	"p9e.in/samavaya/solar3d/electrical-service/internal/config"
	"p9e.in/samavaya/solar3d/electrical-service/internal/db"
...
func main() {
	...
	svc := service.NewElectricalService(repo, cfg.OrchestrationURL)
